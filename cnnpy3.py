...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, kernel_size=(3, 3))  # 第一層卷積層
        self.conv2 = nn.Conv2d(32, 64, kernel_size=(3, 3))  # 第二層卷積層
        self.conv3 = nn.Conv2d(64, 128, kernel_size=(3, 3))  # 第三層卷積層
        ...
        # Dropout 層
        self.dropout = nn.Dropout(0.8)  # 50% 的 Dropout 機率
...
for idx in tqdm(range(len(dataset)), desc="LOOCV Progress"):
    ...
    # 訓練模型
    model.train()
    num_epochs = 5  # 可以根據需要調整 epoch 數量
